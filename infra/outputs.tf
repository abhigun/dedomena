...
output "first_party_container_id" {
 value = module.first_party_container.storage_container_id
}

output "partner_container_id" {
 value = module.partner_container.storage_container_id
}

output "first_party_sftp_password" {
  value = jsondecode(azapi_resource_action.first_party_password.output).sshPassword
}

output "partner_sftp_password" {
  value = jsondecode(azapi_resource_action.partner_password.output).sshPassword
}
