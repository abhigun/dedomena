...
user_manager_updates=(
  ".subscription_id |= \"$subscriptionId\" | .resource_group_name |= \"$resource_group_name\" | .key_vault_id |= \"$key_vault_id\" | .key_vault_name |= \"$key_vault_name\" | .synapse_workspace_name |= \"$synapse_workspace_name\""
